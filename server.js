...
function viewEmployee() {
  ...
  // User chooses the department list, then employees pop up
  ...
  // Makes an employee array to delete
  ...
  // User chooses the employee list, then employee is deleted
 ...
 // Makes an employee array to update
